...
export default function Hero() {
  return (
    <section className="relative pt-32 pb-20 bg-[#170e2c] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        <div className="flex-1 text-center lg:text-left">
          ...
          {/* Improved: Scaled down text for mobile (text-4xl) */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-bold text-white leading-[1.1] mb-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-5">
            <a href="/register" className="bg-white text-[#170e2c] px-8 py-4 rounded-xl font-bold shadow-xl hover:bg-gray-100 transition-all active:scale-95 text-center">
              Get Started for Free
            </a>
            <a href="#how-it-works" className="bg-[#3e3875]/30 border border-white/10 text-white px-8 py-4 rounded-xl font-bold hover:bg-[#3e3875]/50 transition-all text-center">
              See How It Works
            </a>
          </div>
        </div>
        ...
        <div className="flex-1 w-full max-w-xl relative mt-12 lg:mt-0">
          <div className="relative z-10 bg-gradient-to-tr from-[#3e3875]/40 to-transparent p-3 md:p-4 rounded-3xl border border-white/10 backdrop-blur-sm">
            {/* Improved: Added w-full h-auto for responsive image scaling */}
            <Image 
              src="/uploads/purple3.jpg" 
              alt="Platform" 
              width={600} 
              height={450} 
