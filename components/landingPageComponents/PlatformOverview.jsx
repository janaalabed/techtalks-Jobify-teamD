    ...
    <section className="py-24 bg-[#170e2c] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-[#7270b1] font-semibold tracking-[0.2em] uppercase text-xs">
            Our Mission
          </h2>
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
            A complete hiring ecosystem where students apply smarter and companies hire faster, removing the friction from the traditional job hunt.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {overviewItems.map((item, i) => (
            <div
              key={i}
              className={`group p-10 rounded-3xl bg-[#3e3875]/10 border ${item.border} backdrop-blur-sm transition-all duration-500 hover:bg-[#3e3875]/20 hover:-translate-y-2`}
            >
