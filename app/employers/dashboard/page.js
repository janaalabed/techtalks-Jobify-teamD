          ...
          <div className="p-6">
            {loading ? (
              ...
              <div className="grid gap-4">
                {jobs.map((job) => (
                  <div key={job.id} className="group border border-slate-100 rounded-xl p-5 hover:border-[#3e3875]/30 hover:shadow-md transition-all bg-white">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                      ...
                      <div className="flex items-center gap-2 w-full md:w-auto">
                        <button
                          ...
                          className="flex-1 md:flex-none flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-[#3e3875] border border-[#3e3875]/20 rounded-lg hover:bg-indigo-50 transition-colors"
                        >
                          <Edit3 size={16} /> Edit
                        </button>
                        <button
