    ...
    <footer id="contact" className="bg-[#0f0a1d] pt-20 pb-10 border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 text-gray-400">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li><Link href="/terms" className="hover:text-[#7270b1] transition-colors">Privacy Policy</Link></li>
            <li><Link href="/terms" className="hover:text-[#7270b1] transition-colors">Terms of Service</Link></li>
          </ul>
        </div>
